...
const cleanLoginContent = `import { useState } from 'react';
...
fs.writeFileSync(loginPath, cleanLoginContent, 'utf8');
console.log('Successfully removed Quick Fill Credentials box from Login.jsx!');
